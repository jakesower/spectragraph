...
const tenderheartTree = {
  id: tenderheart.id,
  type: tenderheart.type,
  ...tenderheart.properties,
  ...tenderheart.relationships,
};
...
const bearWithHomeAndPowersTree = {
  ...
  home: careBearData.homes[1],
  powers: careBearData.powers.careBearStare,
  best_friend: tenderheart.relationships.best_friend,
};
