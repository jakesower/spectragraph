export const ERRORS = {
  ...
  MULTIPLE_TO_ONE_RELATIONSHIPS: "a resource has a to-one relationship with multiple resources in it",
  ...
  RESOURCE_REFERENCE_NOT_IN_STORE: "resource references must already be present in the store to be used",
