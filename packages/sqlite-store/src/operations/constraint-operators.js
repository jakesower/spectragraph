...
export const sqliteConstraintOperators = mapValues(
	sqliteConstraintOperatorDefs,
	(def) => ({
		...def,
		preQuery: true,
	}),
...
/* ORIGINAL SQLITE-STORE IMPLEMENTATION - KEPT BECAUSE DIFFERENT API FROM SHARED VERSION
