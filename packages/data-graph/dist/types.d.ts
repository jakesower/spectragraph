...
export interface ResourceGraph {
    ...
    relationships?: {
        [k: string]: ResourceGraph | ResourceGraph[];
    };
}
...
export declare type GraphOperation = AddEdgeOperation | AddVertexOperation | UpdateVertexOperation | RemoveEdgeOperation | RemoveEdgesOfTypeOperation | RemoveVertexOperation;
