...
import { omit, mapValues, pick, orderBy, pickBy } from 'lodash-es';
...
const { isExpression: isExpression$1 } = defaultExpressionEngine;
...
function splice(
	...
	const go = (
		...
		/** @type {string} */
		const resultId = res.id ?? existing?.id ?? v4();
...
export { createEmptyGraph, createGraphFromTrees, createMemoryStore, createQueryGraph, createValidator, ensureValidQuery, ensureValidSchema, flattenResource, forEachQuery, forEachSchemalessQuery, linkInverses, mapQuery, mapSchemalessQuery, mergeGraphs, normalizeQuery, normalizeResource, queryGraph, reduceQuery, reduceSchemalessQuery, validateCreateResource, validateDeleteResource, validateResourceTree, validateUpdateResource };
